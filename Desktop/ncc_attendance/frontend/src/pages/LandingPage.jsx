...
export default function LandingPage({ onLogin }) {
  return (
    <div className="space-y-12">
      {/* Hero Section styled as a dark card exactly like the screenshot */}
      <section className="relative isolate overflow-hidden rounded-[2rem] border border-white/5 bg-gradient-to-br from-[#0c1435] via-[#172554] to-[#0a1128] px-5 py-14 text-white shadow-[0_20px_50px_rgba(15,23,42,0.3)] sm:px-10 sm:py-20 lg:px-16 lg:py-24">
        
        {/* NCC watermark logo in the center/right background */}
        <img 
          src={nccLogo} 
          alt="" 
          className="pointer-events-none absolute left-1/2 top-1/2 -z-10 h-[140%] w-auto -translate-x-1/2 -translate-y-1/2 opacity-[0.06] object-contain select-none" 
        />

        {/* Background glow orbs - NCC tri-color theme */}
        <div className="pointer-events-none absolute -left-24 -top-24 h-96 w-96 rounded-full bg-gradient-to-br from-[var(--ncc-navy)]/10 via-[var(--ncc-sky)]/10 to-transparent blur-3xl" />
        <div className="pointer-events-none absolute -right-24 top-1/4 h-[30rem] w-[30rem] rounded-full bg-gradient-to-br from-[var(--ncc-sky)]/10 via-[var(--ncc-red)]/8 to-transparent blur-3xl" />
        ...
        <div className="relative z-10 grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
          ...
          <div className="max-w-3xl">
            ...
            <p className="inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-[0.68rem] font-extrabold uppercase tracking-[0.22em] text-slate-205 text-slate-200 shadow-sm sm:text-xs sm:tracking-[0.28em]">
              <span className="h-2.5 w-2.5 rounded-full bg-[var(--ncc-red)] shadow-[0_0_8px_rgba(216,35,42,0.8)] animate-pulse" />
              NCC Vardhaman Attendance
            </p>
            
            <h1 className="mt-7 text-4xl font-extrabold leading-[1.1] text-white sm:text-6xl lg:text-7xl">
              Discipline in action.<br />
              <span className="text-[#ef4444]">Clarity in command.</span>
            </h1>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:mt-9 sm:flex-row sm:flex-wrap sm:gap-4">
              <button 
                onClick={onLogin} 
                className="w-full rounded-xl bg-[#ef4444] hover:bg-[#dc2626] px-8 py-3.5 text-xs font-bold uppercase tracking-wider text-white shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 sm:w-auto"
              >
                Access the portal
              </button>
              <div className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-5 py-3 text-sm font-semibold text-slate-300 shadow-sm">
          ...
          <div className="hidden justify-center lg:flex relative">
            ...
            <div className="absolute -inset-8 rounded-full bg-gradient-to-tr from-[var(--ncc-navy)]/20 via-[var(--ncc-sky)]/25 to-[var(--ncc-red)]/15 blur-2xl opacity-80" />
            <div className="absolute inset-0 rounded-full border border-white/5 scale-105" />
            <div className="absolute inset-4 rounded-full border border-dashed border-white/10 scale-105" />
            
            <div className="relative z-10 rounded-[2.5rem] bg-white/5 p-8 border border-white/10 shadow-[0_20px_50px_rgba(23,37,84,0.15)] backdrop-blur-md transition-all duration-500 hover:scale-105 hover:bg-white/10 hover:shadow-[0_25px_60px_rgba(23,37,84,0.25)]">
              <img src={nccLogo} alt="NCC Vardhaman" className="h-72 w-72 object-contain filter drop-shadow-[0_4px_12px_rgba(255,255,255,0.05)]" />
            </div>
          </div>
      ...
      {/* Features Grid Section styled as a clean white card */}
      <section className="overflow-hidden rounded-[2rem] border border-slate-200/80 bg-white/95 p-6 shadow-sm sm:p-12">
